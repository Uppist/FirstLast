...
(function () {
  ...
  for (const T of document.querySelectorAll('link[rel="modulepreload"]')) ae(T);
...
function O2() {
  ...
  function tt(f, g, R, F, I) {
    ...
    if (Y)
      return (
        ...
        ke(I)
          ? ((R = ""),
            f != null && (R = f.replace(ct, "$&/") + "/"),
            tt(I, g, R, "", function (Oe) {
              return Oe;
            }))
          : I != null &&
            (Ct(I) &&
    ...
    if (((Y = 0), (F = F === "" ? "." : F + ":"), ke(f)))
      ...
      for (f = b.call(f), W = 0; !(U = f.next()).done; )
        (U = U.value), (b = F + De(U, W++)), (Y += tt(U, g, R, b, I));
    else if (U === "object")
      throw (
        ((g = String(f)),
        Error(
  ...
  return (
    ...
    (B.cloneElement = function (f, g, R) {
      ...
      return { $$typeof: _, type: f.type, key: I, ref: U, props: F, _owner: Y };
    }),
    ...
    (B.useImperativeHandle = function (f, g, R) {
    ...
    (B.useSyncExternalStore = function (f, g, R) {
...
function A2() {
  ...
  var _ = Do(),
    ...
    T = _.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
  ...
  return (
    Fs ||
      ...
      (function (_) {
            ...
            e: for (var f = 0, g = k.length, R = g >>> 1; f < R; ) {
              ...
              if (0 > T(I, E))
                U < g && 0 > T(Y, I)
                  ? ((k[f] = Y), (k[U] = E), (f = U))
                  : ((k[f] = I), (k[F] = E), (f = F));
              else if (U < g && 0 > T(Y, E)) (k[f] = Y), (k[U] = E), (f = U);
              else break e;
            }
          }
          return H;
        ...
        function T(k, H) {
          var E = k.sortIndex - H.sortIndex;
          return E !== 0 ? E : k.id - H.id;
        }
        if (
        ...
        function et(k, H) {
          ...
          try {
            ...
            if (te !== null) var R = !0;
              ...
              var F = m(je);
              F !== null && le(ke, F.startTime - H), (R = !1);
            }
            return R;
          } finally {
            (te = null), (J = E), (We = !1);
        ...
        (_.unstable_IdlePriority = 5),
          ...
          (_.unstable_runWithPriority = function (k, H) {
            switch (k) {
              case 1:
              case 2:
              case 3:
          ...
          (_.unstable_scheduleCallback = function (k, H, E) {
            ...
            return (
              ...
              E > f
                ? ((k.sortIndex = E),
                  ...
                  m(D) === null &&
                    k === m(je) &&
                    (q ? (yt($e), ($e = -1)) : (q = !0), le(ke, E - f)))
                : ((k.sortIndex = g), V(D, k), Qe || We || ((Qe = !0), He(et))),
              k
            );
          }),
          (_.unstable_shouldYield = Xt),
...
function W2() {
  ...
  function oe(e, t) {
    for (T[e] = t, e = 0; e < t.length; e++) ae.add(t[e]);
  }
  var ce = !(
      typeof window > "u" ||
...
` + l[o].replace(" at new ", " at ");
  ...
  var hn = {
    ...
    x1 = Ae(Or),
    pa = E({}, Or, { dataTransfer: 0 }),
    ha = Ae(pa),
    ma = E({}, Xn, { relatedTarget: 0 }),
    si = Ae(ma),
    va = E({}, hn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    ga = Ae(va),
    ya = E({}, hn, {
  ...
  var Ea = E({}, Xn, {
    ...
    Ma = Ae(Na),
    Pa = E({}, hn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Ha = Ae(Pa),
    za = E({}, Or, {
      deltaX: function (e) {
        return "deltaX" in e
    ...
    t1(function () {
      ...
      e: {
        ...
        if (v !== void 0) {
          ...
          0 < L.length &&
            ((v = new x(v, j, null, n, y)), C.push({ event: v, listeners: L }));
        }
      }
      if (!(t & 7)) {
        e: {
          ...
          if (
            ...
            if (
              ...
              t: {
                for (L = x, d = j, c = 0, p = L; p; p = yn(p)) c++;
          ...
          e: {
            ...
            switch (((v = t), (x = n), L.tag)) {
              ...
              case 0:
                if (
                  ((j = L.payload),
                  (v = typeof j == "function" ? j.call(x, C, v) : j),
                  v == null)
                )
                  break e;
                C = E({}, C, v);
...
` +
  ...
  function qu(e, t, n, r, l) {
    ...
    if ((Nn(t, l), t.stateNode === null))
      ...
      u !== C || v !== j || ze.current || Ot
        ? (typeof x == "function" && (qi(t, n, x, r), (j = t.memoizedState)),
          (h = Ot || Ou(t, n, h, r, v, j, a) || !1)
            ? (y ||
                ...
                typeof o.UNSAFE_componentWillUpdate == "function" &&
                  o.UNSAFE_componentWillUpdate(r, j, a)),
...
function Q2() {
  ...
  return _(), (Vo.exports = W2()), Vo.exports;
}
var Is;
function $2() {
  if (Is) return zl;
...
const fc = "./assets/image1-DEicDa6E.png",
  ...
  pc = "_background_m708u_9",
  hc = "_empower_m708u_17",
  mc = "_mobileimg_m708u_125",
  vc = "_desktopimg_m708u_135",
  Vl = { background: pc, empower: hc, mobileimg: mc, desktopimg: vc };
function gc({ aboutRef: _, scrollToSection: V }) {
      ...
      children: [
        s.jsxs("div", {
          children: [
            ...
            s.jsx("button", { onClick: () => V(_), children: "Get Started" }),
          ],
        }),
...
function Vc({ scrollToSection: _, contactRef: V }) {
  return s.jsxs("section", {
            ...
            children: [
              ...
              s.jsxs("div", {
                ...
                children: [
                  ...
                  s.jsx("button", { onClick: () => _(V), children: m.book }),
                ],
              }),
            ],
          })
...
function Yc({ contactRef: _, scrollToSection: V }) {
  return s.jsx("section", {
      ...
      children: [
        s.jsxs("div", {
          children: [
            ...
            s.jsx("button", { onClick: () => V(_), children: "Contact Us" }),
          ],
        }),
...
function h0({ scrollToSection: _, aboutRef: V, serviceRef: m }) {
        ...
        children: [
          ...
          s.jsxs("div", {
            ...
            children: [
              ...
              s.jsxs("ul", {
                children: [
                  s.jsx("li", { onClick: () => _(V), children: "About us" }),
                  s.jsx("li", {
                    onClick: () => _(m),
                    children: "Our Services",
                  }),
...
function m0() {
  ...
  return s.jsxs(s.Fragment, {
    children: [
      ...
      s.jsx("div", {
        ref: ae,
        children: s.jsx(gc, { aboutRef: _, scrollToSection: T }),
      }),
      s.jsx("div", { ref: _, children: s.jsx(Sc, {}) }),
      s.jsx(Lc, {}),
      s.jsx("div", {
        ref: V,
        children: s.jsx(Vc, { contactRef: m, scrollToSection: T }),
      }),
      s.jsx(Ac, {}),
      s.jsx(Yc, { contactRef: m, scrollToSection: T }),
      s.jsx(n0, {}),
      s.jsx("div", {
        ref: m,
        children: s.jsx(h0, { aboutRef: _, serviceRef: V, scrollToSection: T }),
      }),
    ],
  });
}
